        ...
        <div class="pakap-responsive-nav">
            <div class="container">
                <div class="pakap-responsive-menu">
                    <div class="logo">
                        <a href="/"><img src="assets/img/custom/logo.png" alt="logo"></a>
                    </div>
                </div>
            </div>
        </div>
        <div class="pakap-nav">
            <div class="container">
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    <a class="navbar-brand" href="/"><img src="assets/img/custom/logo.png" alt="logo"></a>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="form-group">
                                <input type="text" name="name" class="form-control" id="name" required data-error="Ingrese su nombre" placeholder="nombre">
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="form-group">
                                <input type="email" name="email" class="form-control" id="email" required  data-error="Ingrese su correo electrónico" placeholder="correo electrónico">
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group">
                                <textarea name="message" id="message" class="form-control" cols="30" rows="6" required data-error="Ingrese su mensaje" placeholder="mensaje..."></textarea>
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-contact-info-box">
                            ...
                            <h3><a href="mailto:hello@pakap.com">hello@pakap.com</a></h3>
                            <h3><a href="mailto:info@pakap.com">info@pakap.com</a></h3>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-contact-info-box">
