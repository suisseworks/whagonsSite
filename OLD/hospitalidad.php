    ...
    <div id="wrapper" class="clearfix">
        ...
        <header id="header" class="transparent-header full-header" data-sticky-class="not-dark">
            ...
            <div id="header-wrap" style=" background-color: #FFF !important; color: #002836 !important">
                ...
                <div class="container clearfix">
					...
					============================================= -->
                    <div id="logo">
                        <a href="index.php" class="standard-logo" data-dark-logo="images/logo-dark-hospitality.png"><img src="images/logo.png" alt="Canvas Logo"></a>
                        <a href="index.php" class="retina-logo" data-dark-logo="images/logo-dark-hospitality@2x.png"><img src="images/logo-dark-hospitality@2x.png" alt="Canvas Logo"></a>
                    </div>
                    <!-- #logo end -->
                        ...
                        <div class="swiper-slide dark" style="background-image: url('images/slider/swiper/17.jpg');">
                            <div class="container clearfix">
                                <div class="slider-caption slider-caption-center">
                                    ...
                                    <a target="_blank" href="https://youtu.be/0xdKgh4uvzc">
        ...
        <section id="content">
            ...
            <div class="content-wrap">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-xl-5">
                            <div class="heading-block topmargin">
                                <h1>Optimice y digitalice las operaciones de su Hotel.</h1>
                            </div>
                            <p class="lead">Visibilidad en <i>Tiempo Real</i>. </br>
                                Mejor Comunicación &amp; Control.</p>
                        </div>
                    ...
                    <div class="container clear-bottommargin clearfix">
                        ...
                        <div class="row topmargin-sm clearfix">
                            ...
                            <div class="col-lg-4 bottommargin">
                                ...
                                <p>Optimice la comunicación entre recepción, housekeeping y mantenimiento, eliminando el uso de radios, whatsApp, correos y papelería.</p>
                            </div>
                            ...
                            <div class="col-lg-4 bottommargin">
                                ...
                                <p>Apoye la tome de decisiones a través de reportes que le brindarán información precisa sobre las operaciones de su hotel.</p>
                            </div>
                ...
                <a href="docs/whagons.pdf" class=" hidden button button-full  center tright bottommargin-lg">
                    <div class="container clearfix">
                ...
                <div class="hidden container clearfix">
                    ...
                    <div class="col_two_third bottommargin-sm col_last">
                        ...
                        <div class="heading-block topmargin-sm">
                            <h3>Tips para el uso de Dispositivos en el Hotel</h3>
                        </div>
