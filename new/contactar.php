        ...
        <div class="pakap-responsive-nav">
            <div class="container">
                <div class="pakap-responsive-menu">
                    <div class="logo">
                        <a href="index.html"><img src="assets/img/custom/logo.png" alt="logo"></a>
                    </div>
                </div>
            </div>
        </div>
        <div class="pakap-nav">
            <div class="container">
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    <a class="navbar-brand" href="index.php"><img src="assets/img/custom/logo.png" alt="logo"></a>
    ...
    <div class="contact-area ptb-100">
        <div class="container">
            <div class="section-title">
                <h2>Hablemos</h2>
                <p>Pónte en contacto con nuestros equipos de soporte, ventas o finanzas. Un agente te respoderá cuánto antes.</p>
            </div>
